## [Buck](https://buck.red/) Desktop GUI Wallet troubleshooting guide

![Screenshot1](ZENChat_small.png "Chat Window") ![Screenshot1](BuckWalletMac_0.74.7_small.png "Wallet Window") 
...
```
Linux:    ~/.BuckSwingWallet/BuckGUIWallet_xxxx_xx_debug.log 
Windows:  %LOCALAPPDATA%/BuckSwingWallet/BuckGUIWallet_xxxx_xx_debug.log
Mac OS:   ~/Library/Application Support/BuckSwingWallet/BuckGUIWallet_xxxx_xx_debug.log
```
...
```
/Applications/BuckWallet.app/Contents/Java/zcld -reindex
```
