## [Buck](https://buck.red/) Desktop GUI Wallet known security issues
...
The Buck Desktop GUI Wallet is not compatible with applications that modify the ZEN `wallet.dat` file. The wallet should not be used
