...
echo ""
#package jar to app
jar2app build/jars/BuckSwingWallet.jar -n BuckDesktopWallet  -i ./src/resources/images/buck-logo.icns

#add zcld and zcl-cli into the required Contents folder of the App
cp ./zcld ./BuckDesktopWallet.app/Contents/zcld
cp ./zcl-cli ./BuckDesktopWallet.app/Contents/zcl-cli


chmod +x ./BuckDesktopWallet.app/Contents/zcld
chmod +x ./BuckDesktopWallet.app/Contents/zcl-cli
echo ""
echo "**********************************"
...
dylibbundler -od -b -x ./BuckDesktopWallet.app/Contents/zcld \
                    -x ./BuckDesktopWallet.app/Contents/zcl-cli \
                    -d ./BuckDesktopWallet.app/Contents/libs \
