...
read -p "Are you sure you want to delete your entire BUCK blockchain? (y/N) " -n 1 -r
echo    # (optional) move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
	echo "deleting ~/Library/Application Support/Buck/blocks"
    rm -rf ~/Library/Application Support/Buck/blocks
    echo "deleting ~/Library/Application Support/Buck/chainstate"
    rm -rf ~/Library/Application Support/Buck/chainstate
    echo "success."
else
	echo "Aborted."
fi